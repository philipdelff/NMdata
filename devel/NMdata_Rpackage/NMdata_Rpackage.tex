...
\item
  ...
  \item
    ...
    input data file.
  \item
    \texttt{NMinfo(res1,"input.colnames")}: The translation table of
    input column names from input to output
  \item
    \texttt{NMinfo(res1,"input.filters")}: The ``filters''
    (IGNORE/ACCEPT) from Nonmem and how they are applied in R.
  \item
...
## 
## $mtime.lst
## [1] "2021-06-21 10:30:19 EDT"
## 
## $mtime.mod
## [1] "2021-06-20 23:51:19 EDT"
## 
## $mtime.input
## [1] "2021-06-20 23:38:23 EDT"
\end{verbatim}
\end{column}
\end{columns}
\end{frame}
...
\item
  \texttt{NMdata} includes 57 ``unit tests'' where results of function

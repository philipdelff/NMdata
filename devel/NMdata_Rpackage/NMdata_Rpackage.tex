...
##  8:       DV       DV       DV       DV      OK
##  9:  WEIGHTB     FLAG     FLAG     FLAG    diff
## 10:     FLAG    STUDY    STUDY    STUDY    diff
## 11:    STUDY      BLQ      BLQ      BLQ    diff
## 12:      BLQ    CYCLE    CYCLE    CYCLE    diff
## 13:    CYCLE     DOSE     DOSE     DOSE    diff
## 14:     DOSE     PART     PART     PART    diff
## 15:     PART  PROFDAY  PROFDAY  PROFDAY    diff
## 16:  PROFDAY PROFTIME PROFTIME PROFTIME    diff
## 17: PROFTIME  WEIGHTB  WEIGHTB  WEIGHTB    diff
## 18:     eff0     eff0     eff0     eff0      OK
## 19:   eventu     <NA>     <NA>   eventu    <NA>
## 20:     flag     <NA>     <NA>     flag    <NA>
## 21:     name     <NA>     <NA>     name    <NA>
## 22: timeunit     <NA>     <NA> timeunit    <NA>
## 23:   trtact     <NA>     <NA>   trtact    <NA>
##     datafile     DATA   nonmem   result compare
\end{verbatim}
...
\item
  \texttt{NMdata} includes 40 ``unit tests'' where results of function

...
## 
## $mtime.lst
## [1] "2021-06-17 20:25:24 EDT"
## 
## $mtime.mod
## [1] "2021-06-18 18:09:01 EDT"
## 
## $mtime.input
## [1] "2021-06-19 15:49:08 EDT"
\end{verbatim}
\end{column}
\end{columns}
\end{frame}
...
\begin{verbatim}
##    source                 name nrow ncol nid firstonly
## 1: output      xgxr003_res.txt  905    7  NA     FALSE
## 2: output xgxr003_res_vols.txt  905    7 150     FALSE
## 3: output   xgxr003_res_fo.txt  150    2 150      TRUE
## 4:  input            xgxr1.csv 1502   24 150        NA
##    lastonly firstlastonly   format  sep idlevel has.col.row
## 1:    FALSE         FALSE                 FALSE        TRUE
## 2:    FALSE         FALSE   tF13.4        FALSE       FALSE
## 3:    FALSE         FALSE ,1PE15.8    ,    TRUE       FALSE
## 4:       NA            NA     <NA> <NA>      NA        TRUE
##    maxLength full.length filetype
## 1:      TRUE        TRUE   output
## 2:      TRUE        TRUE   output
## 3:     FALSE       FALSE   output
## 4:        NA          NA     text
##                                                                              file
...
## 2: 2021-04-05 21:57:22
## 3: 2021-04-05 21:57:22
## 4: 2021-06-19 15:49:08
\end{verbatim}
\end{block}
\end{column}
...
\CommentTok{\#\#\# shortcuts to examples in NMdata}
\NormalTok{file.data \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(...) }\KeywordTok{system.file}\NormalTok{(}\StringTok{"examples/data"}\NormalTok{,..., }\DataTypeTok{package=}\StringTok{"NMdata"}\NormalTok{)}
\NormalTok{file.nm \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(...) }\KeywordTok{system.file}\NormalTok{(}\StringTok{"examples/nonmem"}\NormalTok{,..., }\DataTypeTok{package=}\StringTok{"NMdata"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
\end{column}
\end{columns}
...
\item
  \texttt{NMdata} includes 88 ``unit tests'' where results of function
...
\begin{center}\includegraphics[height=0.75\textheight]{plots/unnamed-chunk-45-1} \end{center}
\normalsize
\end{frame}

...
list.
*** compareCols
**** TODO rows are not being sorted correctly.
...
*** NMwriteData
**** TODO Include a randomly generated ID in meta data that we can check files against?
**** TODO When writing a CSV, write meta data to separate file
...
** BUGS
*** TODO Often, messages from messageWrap (I think) get printed twice

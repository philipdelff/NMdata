...
*** DONE [#B] messageWrap internal/external
    ...
    somehow?
** New functions
*** TODO function to add variables to $TABLE                    :newFunction:
...
*** NMwriteSection
**** DONE [#A] Put backup files in NMdata_backup
...
*** NMscanInput
**** TODO Time check of lst vs input belongs here rather than in NMscanData
...
**** TODO Integrate the reduction into one table from NMscanData
**** DONE Lastonly does the same as firstonly
*** NMscanData
**** TODO [#B] Split out data finder handling
...
*** summary.NMdata
**** TODO Put message about how stuff was merged after table overview
**** TODO EVID/CMT table: Switch order of output and input only and add "result"
**** TODO EVID/CMT table: add a total line (use rollup?)

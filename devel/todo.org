...
*** DONE messageWrap internal/external
    ...
    somehow?
** High level features
*** TODO [#A] Support for DATE type columns
** New functions
*** document columns
...
*** getArgs
**** TODO [#A] Make sure functions that use it can work with lapply
*** NMcheckColNames
...
fail.
*** NMcheckData
**** TODO [#A] RATE=-1 is OK :v0_1_7:
**** TODO [#A] CMT can be any non-zero integer :v0_1_7:
But more than say 20 compartments seems unlikely
**** TODO [#A] Support for a table of accepted findings
...
**** DONE [#A] Multi-char delimters do not work
like ; 1; CL ; [mL/h]
in which case "; [" is a delimiter
**** DONE [#A] Empty fields make it break
Like ;1;CL;;;mL/h
**** TODO [#B] Handle SAME
***** TODO [#A] Include test so we at least know what happens
*** NMreadSection
...
*** TODO [#A] NMrelate
*** NMreplaceDataFile
**** TODO [#A] Fails on dir+file.pattern

...
*** egdt
**** TODO [#A] BUG the tmp by col has to be removed before reporting dims
...
*** NMwriteData
**** DONE [#A] BUG NA's are not .
     CLOSED: [2022-01-25 Tue 16:22]

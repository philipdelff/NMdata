...
*** NMscanInput
**** TODO [#B] Get number of subjects as before filtering
...
a likely reason.
**** TODO [#A] Add support for merge.by.row="ifAvailable"
**** TODO [#A] Make sure all options in NMdataConf are documented?
...
*** summary.NMdata
**** DONE Rethink and tidy up message
     CLOSED: [2021-05-15 Sat 21:06]
** Nonmem examples
*** DONE Use FLAG
    CLOSED: [2020-06-29 Mon 21:28]

...
*** Dosing functions
**** TODO [#A] NMcreateDoses Generate dosing schedule with loading, ADDL etc
...
*** NMcheckData
**** TODO [#A] cols.num split on other columns
...
*** NMcheckDataFile
**** TODO [#A] Check all columns as cols.num
**** TODO [#A] Return data, summary and more

...
*** TODO [#A] Summary of the columns - columns?
    right now hidden in metadata
*** TODO [#A] Summary of tables - tables?
...
*** NMextractDataFile
**** TODO [#A] Add support for windows absolute paths
*** NMwriteSection
...
**** DONE [#A] Check if col.row is being modified in Nonmem.
     CLOSED: [2021-05-14 Fri 13:24]
...
**** TODO [#A] Add support for custom fwrite arguments
...
**** TODO [#A] Add save argument to align with other functions
*** NMdataConf
...
*** stampObj
**** TODO [#A] Include output filename in stamp
*** summary.NMdata

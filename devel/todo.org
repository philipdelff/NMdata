...
*** NMtransInput
**** TODO A=B labels should be matched against reserved variable names
***** Introduce a pseudonyms=TRUE argument to let the user decide what they want.
...
**** TODO New argument to define columns to read from input data
...
**** TODO Look for any updates by reference
**** Update vignettes
***** DONE NMscanData

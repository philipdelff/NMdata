...
**** TODO [#A] Checks for presense of II and ADDL should report dependence
...
**** TODO [#A] ADDL and II: II cannot be >0 if ADDL=0
...
it all in rds.
**** TODO [#A] Change from write.csv, write.rds etc to formats and save

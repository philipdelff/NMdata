...
**** TODO fnExtension("run.lst","") should return run
**** TODO fnExtension("run.lst") should return lst
>>>>>>> 9654a90d5c9fb1f34537b9ddd06547aaa2418e1b
...
*** NMscanInput
**** TODO Make work without filters
...
*** NMwriteData
**** TODO [#A] Include option for non-nonmem data
...
**** DONE Polish
*** flagsAssign
**** TODO [#A] subsets of zero rows should return a message, not an error

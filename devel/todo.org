...
*** mergeCheck
**** DONE [#A] Test the check for row duplications
     CLOSED: [2021-12-16 Thu 21:45]
*** NMcheckData
**** DONE [#A] Check for , in character column contents not working
     CLOSED: [2021-12-16 Thu 15:07]
**** DONE [#A] Checks for availability
...
**** DONE [#A] Element-wise NMisNumeric
...
**** DONE [#A] Only check for special characters in colnames for numeric columns

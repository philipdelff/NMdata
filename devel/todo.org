...
*** TODO [#A] listMissings                              :v0_0_11:newFunction:
...
*** TODO [#A] NMcreateDoses Generate dosing schedule with loading, ADDL etc :v0_0_11:newFunction:
...
**** TODO [#A] Warning if NA in by columns :v0_0_11:
**** TODO [#A] merge in try :v0_0_11:
...
**** TODO [#A] cols.num split on other columns :v0_0_11:
...
*** NMcheckDataFile
**** TODO [#A] Check all columns as cols.num                        :v0_0_11:
**** TODO [#A] Return data, summary and more :v0_0_11:
...
*** Vignettes
**** TODO [#A] Take cheatsheet out of package                       :v0_0_11:
*** pkgdown
**** TODO Add bug list

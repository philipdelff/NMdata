...
**** DONE Report dims(df1,df2,result) unless qu
*** listMissings
...
**** TODO [#A] Integrate the reduction into one table from NMscanData
...
*** summary.NMdata
**** TODO Put message about how stuff was merged after table overview :v0_0_12:
**** TODO EVID/CMT table: Switch order of output and input only and add "result" :v0_0_12:
**** TODO EVID/CMT table: add a total line (use rollup?)            :v0_0_12:

...
**** TODO [#A] arg to disable looking for some columns
...
*** NMreadParsText
**** DONE [#A] order columns - created ones to the right
...
Like ;1;CL;;;mL/h
**** TODO [#B] Handle SAME
***** DONE [#A] Include test so we at least know what happens
*** NMreadSection
...
**** TODO [#A] would be better if NMrelateOne added par.type
**** TODO [#A] Count how many times the combination of par.type,i,j is matched on the RHS

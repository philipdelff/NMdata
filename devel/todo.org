...
*** TODO Check assign by ref inside package
...
**** DONE Improve messages at each FLAG coding
     CLOSED: [2020-12-23 Wed 11:31]
**** TODO Make sure we arrange back to original order
...
** BUGS
*** TODO NMorderColumns doesn't use first
    Is it sorting at all?
*** TODO NMscanData can't handle all rds with chars or something?
*** TODO flagsCount makes no sense

...
***** TODO warning if duplicated column names
...
*** TODO [#A] cc - create character vector function
*** Dosing functions
...
*** DONE Summary of tables - NMinfo
    CLOSED: [2021-05-14 Fri 15:38]
*** TODO [#A] A function to check data - NMcheckData
...
*** egdt
**** TODO [#A] Report dims(df1,df2,result) unless quiet
*** NMextractDataFile
...
*** NMwriteData
**** DONE [#A] Bug in inclusion of filename in text
...
**** TODO [#A] Only give message about overwriting FLAG/flag if non-NA values are present

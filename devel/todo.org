...
in var table 
*** NMwriteData
**** TODO Check if character variables contain commas. 
This will cause trouble when writing csv
**** TODO The Nonmem instructions should not include characters
...
**** TODO There are certain variables that can only be row specifc
WRES, CWRES, etc.
** Nonmem examples
*** DONE Use FLAG
    CLOSED: [2020-06-29 Mon 21:28]
...
*** TODO Get overview of functionality contents
*** TODO Remove all debug arguments

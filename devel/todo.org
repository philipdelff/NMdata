...
*** findCovs
*** compareCols
**** TODO [#A] Only print results if data.table is non-empty
**** TODO [#B] print results should be run through as.fun
...
**** TODO [#B] If nothing found, return an empty data.table ()

$PROBLEM    014 with TABLE options NOHEADER ONEHEADER NOLABEL
...
$TABLE ROW TVKA TVV NOPRINT NOHEADER FILE=xgxr033_res_a.txt
$TABLE ROW IPRED NOPRINT ONEHEADER FILE=xgxr033_res_c.txt
$TABLE ROW IPRED NOPRINT NOLABEL FILE=xgxr033_res_d.txt

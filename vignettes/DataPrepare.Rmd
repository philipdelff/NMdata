...
* Using `mergeCheck` to automatically check merge results, ensuring rows do not get lost or duplicated
...
* Using `NMcheckData` to perform a extensive data check before exporting for Nonmem

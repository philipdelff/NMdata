...
Please make sure to check for latest version on (https://github.com/philipdelff/NMdata/releases)
...
if you want `data.table`, use `"data.table"` (notice as a character string, not a function) to avoid the conversion
...
And all `NMdata` functions (that return data) should now return tibbles or

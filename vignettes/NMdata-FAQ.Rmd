...
`NMdata 0.0.7.2` release, do (notice "@v":)
...
any dependencies. R 3.0 or later is required, that's all (yes, you can run NMdata on pretty old R installations without any
difference).

...
very powerful and flexible, and when preparing a data set, they are as
fundamental as anything. However, many merges for dataset creation are
...
If you use all.x and check the dimensions, you shoul be OK. Then you
just have to reorder the resulting rows if you want to retrieve the
order of one of the original data.frames.
...
The result always has the same order of rows as the x1 argument. There
...
of functons in NMdatra help you do this in a way that is easy to

...
```{r}
res1 <- NMscanData(file.NMdata("xgxr003.lst"),quiet=TRUE)
```
...
Return to the example above creating the dataset `dat2`. Notice in the
list of tables in the message from `NMscanData`, that input data is a
